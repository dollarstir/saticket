                        ...
                        <div class="card dashboard-card-six pd-b-20">
                            <div class="card-body">
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php                                         
                                            $sql = "SELECT * FROM voucher WHERE status = 'sold'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                        ...
                        <div class="card dashboard-card-six pd-b-20">
                            <div class="card-body">
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php                                        
                                            $sql = "SELECT * FROM voucher WHERE mop = 'cash'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE mop = 'momo'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                    ...
                    <div class="col-lg-6 col-xl-6 col-4-xxxl">
                        <div class="card dashboard-card-six pd-b-20">
                            <div class="card-body">
                                <div class="heading-layout1 mg-b-17">
                                    <div class="item-title">
                                        <h3>Total Vouchers Available</h3>
                                    </div>
                                    <div class="dropdown">
                                        <a class="dropdown-toggle" href="#" role="button" data-toggle="dropdown"
                                            aria-expanded="false">...</a>
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE gender = 'male' AND attendStatus = 'Attended'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE gender = 'female' AND attendStatus = 'Attended'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE attendStatus = 'Attended'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
