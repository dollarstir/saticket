...
echo '<div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="sidebar">
                ...
                <ul class="list-unstyled menu-categories" id="accordionExample">
                    ...
                    <ul class="collapse submenu list-unstyled" id="page" data-parent="#accordionExample">
                        <li>
                            <a href="home1.php">LEGON</a>
                        </li>
                        <li>
                            <a href="home2.php"> KNUST </a>
                        </li>

                        <li>
                            <a href="home3.php"> UCC </a>
                        </li>
                        <li>
                        <a href="home4.php"> HO-TECH </a>
                    </li>
                ...
                <li class="menu">
                    ...
                    <li class="menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="ui-features" data-parent="#accordionExample">
                            ...
                            <li>
                                <a href="voucher.php"> View All Vouchers</a>
                            </li>
