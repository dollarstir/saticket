                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE location = 'knust'";
                                            $count = 0;
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE status = 'sold' AND location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE mop= 'cash' AND location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE mop = 'momo' AND location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE status = 'available' AND location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM volunter WHERE location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE gender = 'male' AND attendStatus = 'Attended' AND location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE gender = 'female' AND attendStatus = 'Attended' AND location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE attendStatus = 'Attended' AND location = 'knust'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
