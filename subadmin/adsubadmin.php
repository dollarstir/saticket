                            ...
                            <div class="widget-header">                                
                                <div class="row">
                                    <div class="col-xl-12 col-md-12 col-sm-12 col-12">
                                       <center><u><h4>Add Sub-Admins</h4></u></center>
                                    </div>                                                      
                                </div> 
                            </div>
                            <div class="widget-content widget-content-area">
                                <form class="subm_Sub">
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <input type="submit" name="sub" class="mt-4 mb-4 btn btn-button-7 btn-rounded sub" value="Add SubAdmin" style="margin-left:100px;background-color:green !important;">
                                    ...
                                    <div id="respo" style="display: none;font-weight: bolder;text-align: center"></div>
