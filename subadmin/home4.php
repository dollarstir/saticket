    ...
    <header class="header navbar fixed-top navbar-expand-sm">
        ...
        <ul class="navbar-nav flex-row ml-lg-auto">
            ...
            <li class="nav-item  d-lg-block d-none">
                <form class="form-inline" role="search"  style="height: -10px;">
                    <input type="text" class="form-control search-form-control" placeholder="Search..."  style="height: 40px; width: 100%;">
                </form>
            </li>
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE location = 'hotech'";
                                            $count = 0;
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE status = 'sold' AND location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE mop = 'cash' AND location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE mop='momo' AND location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE status = 'available' AND location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM volunter WHERE location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE gender = 'male' AND attendStatus = 'Attended' AND location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE gender = 'female' AND attendStatus = 'Attended' AND location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
                                ...
                                <div class="media-body text-left">
                                    ...
                                    <span class="widget-numeric-value">
                                        <?php
                                            ...
                                            $sql = "SELECT * FROM voucher WHERE attendStatus = 'Attended' AND location = 'hotech'";
                                            $count = 0;
                                            $query = mysqli_query($conn, $sql);
