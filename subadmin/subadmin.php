        ...
        <div id="content" class="main-content">
            <div class="container">
                <div class="page-header">
                    ...
                    <?php 
                            if($_SESSION['loc'] == 'ucc') {
                                echo ' <h3>UNIVERSITY OF CAPE COAST</h3>
                                <div class="crumbs">
                                    <ul id="breadcrumbs" class="breadcrumb">
                                        <li><a href="home.php"><i class="flaticon-home-fill"></i></a></li>
                                        <li><a href="#">Venue</a></li>
                                       
                                        <li class="active"><a href="#">UCC</a> </li>
                                    </ul>
                                </div>';

                            }elseif ($_SESSION['loc'] == 'legon') {
                                echo ' <h3>UNIVERSITY OF GHANA</h3>
                                <div class="crumbs">
                                    <ul id="breadcrumbs" class="breadcrumb">
                                        <li><a href="home.php"><i class="flaticon-home-fill"></i></a></li>
                                        <li><a href="#">Venue</a></li>
                                ...
                                echo ' <h3>KWAME NKRUMAH UNIVERSITY OF SCIENCE AND TECHNOLOGY</h3>
                                <div class="crumbs">
                                    <ul id="breadcrumbs" class="breadcrumb">
                                        <li><a href="home.php"><i class="flaticon-home-fill"></i></a></li>
                                        <li><a href="#">Venue</a></li>
                                ...
                                echo ' <h3>HO TECHNICAL UNIVERSITY</h3>
                                <div class="crumbs">
                                    <ul id="breadcrumbs" class="breadcrumb">
                                        <li><a href="home.php"><i class="flaticon-home-fill"></i></a></li>
                                        <li><a href="#">Venue</a></li>
                                       
                                        <li class="active"><a href="#">HO-TECH</a> </li>
                                    </ul>
                                </div>';
                            }else{
                                echo 'unknown location';
                        ...
                        <div class="statbox widget box box-shadow">
                            <div class="widget-header">
                                <div class="row">
                                    ...
                                    <?php 
                            if($_SESSION['loc'] == 'ucc') {
                                echo ' <h4>UNIVERSITY OF CAPE COAST</h4>
                                ';

                            }elseif ($_SESSION['loc'] == 'legon') {
                                echo ' <h4>UNIVERSITY OF GHANA</h4>
                               ';

                            }elseif ($_SESSION['loc'] == 'knust') {
                                echo ' <h4>KWAME NKRUMAH UNIVERSITY OF SCIENCE AND TECHNOLOGY</h4>
                                ';

                            }elseif ($_SESSION['loc'] == 'hotech') {
                                echo ' <h4>HO TECHNICAL UNIVERSITY</h4>
                               ';
                            }else{
                                echo 'unknown location';
                            }
