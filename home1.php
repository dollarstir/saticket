            ...
            <div class="media-body text-left">
                <p class="widget-text mb-0">Voucher : 
                    <span class="widget-numeric-value">
                        <?php
                            $loc = $_SESSION['loc'];
                            $sql = "SELECT * FROM voucher WHERE location = '$loc'";
                            $count = 0;
    ...
    <div class="widget-content-area  data-widgets br-4">
        <div class="widget  t-income-widget">
            <div class="media">
                ...
                <div class="media-body text-right">
                    <p class="widget-text mb-0">Voucher Sold</p>
                    <p class="widget-numeric-value">
                    </p>
                </div>
            </div>
            <div class="media-body text-left">
                <p class="widget-text mb-0">Voucher : 
                    <span class="widget-numeric-value">
                        <?php
                            $loc = $_SESSION['loc'];
                            $sql = "SELECT * FROM voucher WHERE location = '$loc' AND status = 'sold'";
                            $count = 0;
                            $query = mysqli_query($conn, $sql);
    ...
    <div class="widget-content-area  data-widgets br-4">
        <div class="widget  t-income-widget">
            <div class="media">
                ...
                <div class="media-body text-right">
                    <p class="widget-text mb-0"> Vouchers Available</p>
                    <p class="widget-numeric-value">
                    </p>
                </div>
            </div>
            <div class="media-body text-left">
                <p class="widget-text mb-0">Voucher : 
                    <span class="widget-numeric-value">
                        <?php
                            $loc = $_SESSION['loc'];
                            $sql = "SELECT * FROM voucher WHERE location = '$loc' AND status = 'Available'";
                            $count = 0;
                            $query = mysqli_query($conn, $sql);
...
<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6">
        ...
        <div class="widget-content-area  data-widgets br-4">
            <div class="widget  t-income-widget">
                ...
                <div class="media-body text-left">
                    <p class="widget-text mb-0">Volunter : 
                        <span class="widget-numeric-value">
                            <?php
                                $team = $_SESSION['team'];
                                $loc = $_SESSION['loc'];

                                $sql = "SELECT * FROM volunter WHERE team = '$team' AND location = '$loc'";
                                $count = 0;
                                $query = mysqli_query($conn, $sql);
...
<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-sm-0 mb-4" style="margin-top: 20px; height: 150px; float: left;">
    <div class="widget-content-area  data-widgets br-4">
        <div class="widget  t-income-widget">
        <div class="media">
                <div class="icon ml-2">
                ...
                <div class="media-body text-right">
                    <p class="widget-text mb-0"> Vouchers Sold by Cash</p>
                    <p class="widget-numeric-value">
                    </p>
                </div>
            </div>
...
<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-sm-0 mb-4"  style="margin-top: 20px; height: 150px;  float: left;">
    <div class="widget-content-area  data-widgets br-4">
        ...
        <div class="media">
                ...
                <div class="media-body text-right">
                    <p class="widget-text mb-0"> Vouchers Sold by MoMo</p>
                    <p class="widget-numeric-value">
                    </p>
                </div>
            </div>
...
<div class="col-xl-3 col-lg-6 col-md-6 col-sm-6 mb-sm-0 mb-4"  style="margin-top: 20px; height: 150px;  float: left;">
    <div class="widget-content-area  data-widgets br-4">
        ...
        <div class="media">
                ...
                <div class="media-body text-right">
                    <p class="widget-text mb-0"> No. of Volunteers</p>
                    <p class="widget-numeric-value">
                    </p>
                </div>
            </div>
